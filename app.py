...
def reset_game(low_value: int, high_value: int) -> None:
    """Reset all game state for the active difficulty."""
...
# Make sure the secret always matches the active difficulty.
if "secret" not in st.session_state:
    reset_game(low, high)

# Reset fully whenever difficulty changes.
